<template>
  <div class="py-4 container-fluid">
    <div class=" row">
      <div class="col-12">
        <div class="card w-100 mb-4">
          <div class="card-body">
            <div class="part1">
              <h5 class="card-title font-weight-bolder dark">Recuperer credit un compte</h5>
              <p class="card-text border-bottom">Debiter le compte d'un client.</p>
              <div class="row">
    ...
    <SelectComp v-model="beneficiaireSelect" type="1" :data="optionsUser" placeholder="Selectionner l'utilisateur" />
        ...
        <div class="card w-100 mb-10" v-show="serviceSelect.id == 1">
          <div class="card-body">
            <div class="part1">
              ...
              <p class="card-text border-bottom">Renseignez la quantite de SMS a debiter et le pays.</p>
              <div class="row">
                <div class="col-lg-4 col-sm-12 form-group  ">
...
<option disabled selected default>
  Selectionner le pays
                ...
                <form-number class="col-lg-4 col-sm-12 form-group" label=" Quantite" v-model='montant'>
                </form-number>
        ...
        <div class="card w-100 mb-10" v-show="serviceSelect.id == 2">
          <div class="card-body">
            <div class="part1">
              <h4 class="card-title font-weight-bolder dark">Completez la procedure</h4>
              <p class="card-text border-bottom">Renseignez le montant a debiter chez le client.</p>
              <div class="row">

                <form-number class="col-lg-4 col-sm-12 form-group" label=" Montant" v-model='montant'>
                </form-number>
    ...
    <vue-final-modal v-model="achat" style="" classes="modal-container-paiement   "
      ...
      <p class="card-text border-bottom">Debiter le compte d'un client.</p>
      <h6 class="card-title font-weight-bolder dark">Retrait de {{ montant }} au compte de Mr
